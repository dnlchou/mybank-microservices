...
public class Api {
	...
	public Account findByNumber(@PathVariable("number") Integer number) {
	...
	public List<Account> findByCustomer(@PathVariable("customer") Integer customerId) {
		logger.info(String.format("Account.findByCustomer(%s)", customerId.intValue()));
	...
	public List<Account> findAll() {
		...
		logger.info(String.format("Account.findAll: ", accounts));
		return accounts;
	}
